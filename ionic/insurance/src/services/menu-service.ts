...
export class MenuService implements IService {
  ...
  getAllThemes = (): Array<any> => {
    return [
      ...
      // { "title": "Register User", "theme": "register", "icon": "icon-comment-account", "listView": false, "component": "", "singlePage": false },
      ...
      { "title": "Premium Payment", "theme": "payment", "icon": "icon-cash", "listView": false, "component": "", "singlePage": false },
      { "title": "Payment History", "theme": "timeline", "icon": "icon-timer", "listView": false, "component": "", "singlePage": false },
  ...
  getDataForTheme = (menuItem: any) => {
    return {
      ...
      "image": "https://res.cloudinary.com/brainethic/image/upload/v1546860632/EI-logo-transperent_vvwqdz.png",
